...
from (values
  ...
  ('דלתא', 'אופנה', 'https://www.delta.co.il', 'percent', 5, 60, false, true),
  ('אורבניקה', 'אופנה', 'https://www.urbanica-wh.com', 'percent', 5, 60, false, true),
  ...
  ('פנדה', 'קניות כלליות', 'https://pandazzz.co.il', 'percent', 4, 60, false, true),
