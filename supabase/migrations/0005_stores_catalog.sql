...
from (values
  ...
  ('FOX', 'אופנה', 'https://www.fox.co.il', 'percent', 5, 60, false, true),
  ('GOLF', 'אופנה', 'https://www.golf.co.il', 'percent', 5, 60, false, true),
  ('Renuar', 'אופנה', 'https://www.renuar.co.il', 'percent', 5, 60, false, true),
  ('Mania Jeans', 'אופנה', 'https://www.maniajeans.co.il', 'percent', 5, 60, false, true),
  ('Delta', 'אופנה', 'https://www.delta.co.il', 'percent', 5, 60, false, true),
  ('Urbanica', 'אופנה', 'https://www.urbanica-wh.com', 'percent', 5, 60, false, true),
  ('אלם', 'אופנה', 'https://www.alm.co.il', 'percent', 5, 60, false, true),
  ...
  ('נעמן', 'בית וריהוט', 'https://www.naamanp.co.il', 'percent', 4, 60, false, true),
  ('Home Center', 'בית וריהוט', 'https://www.homecenter.co.il', 'percent', 4, 60, false, true),
  ('ד"ר גב', 'בית וריהוט', 'https://www.dr-gav.co.il', 'percent', 4, 60, false, true),
  ('קרביץ', 'קניות כלליות', 'https://www.kravitz.co.il', 'percent', 4, 60, false, true),
  ('Panda', 'קניות כלליות', 'https://pandazzz.co.il', 'percent', 4, 60, false, true),
  ('Last Price', 'קניות כלליות', 'https://www.lastprice.co.il', 'percent', 4, 60, false, true),
  ('Steimatzky', 'ספרים', 'https://www.steimatzky.co.il', 'percent', 4, 60, false, true),
  ('אלוף הספורט', 'ספורט', 'https://www.alufsport.co.il', 'percent', 5, 60, false, true),
  ('Mega Sport', 'ספורט', 'https://www.megasport.co.il', 'percent', 5, 60, false, true),
  ('Isrotel', 'טיסות ומלונות', 'https://www.isrotel.co.il', 'percent', 5, 60, false, true)
